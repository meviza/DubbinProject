...
export function SiteHeader({ locale, route }: SiteHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-40 mx-auto flex w-full max-w-7xl flex-col gap-4 rounded-[30px] border border-white/10 bg-slate-950/[0.6] px-4 py-4 backdrop-blur-2xl md:flex-row md:items-center md:justify-between">
      <BrandMark
        href={`/${locale}`}
        eyebrow="Dubbin OS"
